const services = [
  {
    ...
    description: "Tailored solutions for modern homes. We upgrade, install, and protect your household electrical systems to ensure safety, comfort, and efficiency.",
    points: [
  ...
  },
  {
    ...
    description: "Comprehensive and durable solutions for industrial operations. We handle high-capacity systems, automation, and preventive strategies.",
    points: [
  ...
  },
  {
    ...
    description: "Reliable infrastructure to keep your business running. From lighting upgrades to emergency support, we’ve got it covered.",
    points: [
  ...
  },
  {
    ...
    description: "Innovative energy and smart home solutions. Upgrade your lifestyle or business with solar, EV charging, and smart integrations.",
    points: [
      ...
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-16">
          ...
          <p className="mt-4 max-w-3xl mx-auto text-white/60 text-base md:text-lg">
            At Powerflow, we provide a complete range of electrical services designed to deliver safety, innovation, and energy efficiency. Whether you're upgrading your home, expanding your business, or managing a facility, our experienced team delivers dependable results at every level.
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-12">
          {services.map((section, index) => (
            ...
            >
              <h3 className="text-xl font-bold text-[#B3001E] mb-2">{section.title}</h3>
